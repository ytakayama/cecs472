...
void
Echo::Line::operator>>= (cdrStream &_n) const
{
  {
    _n.declareArrayLength(omni::ALIGN_1, 20);
    for (_CORBA_ULong _0i0 = 0; _0i0 < 20; _0i0++){
      _n.marshalChar(data[_0i0]);
    }
  }
...
void
Echo::Line::operator<<= (cdrStream &_n)
{
  {
    for (_CORBA_ULong _0i0 = 0; _0i0 < 20; _0i0++){
      data[_0i0] = _n.unmarshalChar();
    }
  }
...
Echo::Line _objref_Echo::echoString(const ::Echo::Line& mesg)
{
  ...
  _call_desc.arg_0 = &(::Echo::Line&) mesg;
